...
namespace OpcPublisher
{
    ...
    public class HubCommunication
    {
        ...
        private static string _hubConnectionString = "HostName=demo-hub-iot.azure-devices.net;DeviceId=device-01;SharedAccessKey=S7+L9d1h0iRhhhzMpYXu9tcZz7zZXNq4Mc8YBfaglbI=";
        ...
        private static async Task ProcessAsync()
        {
            ...
            if (CloudStorageAccount.TryParse(storageConnectionString, out storageAccount))
            {
                try
                {
                    ...
                    string localFileName = "tema6.txt";
